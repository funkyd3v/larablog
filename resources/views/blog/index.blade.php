...
<div class="pt-15 w-4/5 m-auto my-3">
    <a href="/blog/create"
        class="uppercase text-xs font-semibold px-5 py-2 bg-blue-600 text-gray-200 rounded-3xl">Create Post</a>
</div>
@endif
...
<div class="sm:grid grid-cols-2 gap-20 w-4/5 border-b  border-x-gray-200 py-16 mx-auto">
    ...
    <div>
        ...
        <span class="text-gray-500">
            By <span class="font-bold italic text-gray-800">{{ $post->user->name }}</span>, Created at {{ date('jS M Y',
        ...
        <a href="/blog/{{ $post->slug }}"
            class="text-l font-extrabold text-gray-200 bg-blue-600 uppercase px-8 py-4 rounded-3xl">Keep Reading</a>
        @if (Auth::check())
